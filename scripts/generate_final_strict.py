...
# 1. Fetch metadata with dates from YouTube channel directly
cmd = [
    'python', '-m', 'yt_dlp',
...
print("Fetching channel metadata with dates...")
...
# Save to Sensebar_AI_Agent_Videos_Full_Version.md
...
print(f"SUCCESSFULLY GENERATED Sensebar_AI_Agent_Videos_Full_Version.md WITH {len(all_urls)} VIDEOS")
