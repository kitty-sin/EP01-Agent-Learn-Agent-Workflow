...
# Rules 2 & 4: Granular Distinct Categories
categories = {
...
with open('clean_2025_md.md', 'w', encoding='utf-8') as f:
    f.write(md_content)

with open('clean_2025_urls.txt', 'w', encoding='utf-8') as f:
    f.write(txt_content)

print(f"DONE! {len(all_urls)} videos written to clean_2025_md.md")
